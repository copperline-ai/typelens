          ...
          <div className="flex min-h-0 flex-1 flex-col gap-4">
            ...
            {status === "error" && (
              <div className="flex items-center gap-2 rounded-md border border-destructive/20 bg-destructive/5 px-4 py-2 text-sm text-destructive">
                ...
                <button
                  type="button"
                  onClick={() => testConnectionIfNeeded()}
                  className="rounded-md border border-destructive/30 px-2.5 py-0.5 text-xs font-medium transition-colors hover:bg-destructive/10"
                >
                  Retry connection
                </button>
              </div>
